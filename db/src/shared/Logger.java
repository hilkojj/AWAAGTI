...
public class Logger {
    ...
    public static void log(Object o, ConsoleColors cc) {
        System.out.print(cc);
        log(o);
    ...
    public static void error(Object o, ConsoleColors cc) {
        System.err.print(cc);
        error(o);
    ...
    /**
     * These are the colors/effects that can be printed in the console.
     * A color change also needs to be RESET to the normal color.
     */
